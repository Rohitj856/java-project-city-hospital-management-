...
└── README.md
Data Flow Diagram
User → Main Menu → Hospital System → File Storage
User → Add Doctor → doctors.csv
User → Add Patient → patients.csv
User → Book Appointment → appointments.csv
User → Cancel Appointment → appointments.csv
User → View Lists → Read CSV files
Purpose of the Project
This project demonstrates the use of Object-Oriented Programming, file handling, and real-world system design in Java.
It simulates basic hospital operations in a structured, automated way.
